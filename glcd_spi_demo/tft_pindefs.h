/* -----------------------------------------------------------------------------------
  ...
  #include "tftdisplay.h"
    ...
    /*  ------------------------------------------------------------
      ...
      #define lcd_pin_init()    ( gpio_set_mode(GPIOA, GPIO_MODE_OUTPUT_50_MHZ, GPIO_CNF_OUTPUT_PUSHPULL, lcd_pin_mask) )
      ...
      #define lcd_pin_init()    { gpio_set_mode(GPIOA, GPIO_MODE_OUTPUT_50_MHZ, GPIO_CNF_OUTPUT_PUSHPULL, lcd_pin_mask);    \
                                  gpio_set_mode(GPIOB, GPIO_MODE_OUTPUT_50_MHZ, GPIO_CNF_OUTPUT_PUSHPULL, lcd_rst);  }
    ...
    #if (pindefs == 4)
      // LCD-Testshield 2 mit umsteckbaren Logigpegeln
      ...
      #define lcd_pin_mask      ( lcd_rst | lcd_dc | lcd_ce)
  /*
      #define lcd_pin_init()    { gpio_set_mode(GPIOB, GPIO_MODE_OUTPUT_50_MHZ, GPIO_CNF_OUTPUT_PUSHPULL, lcd_pin_mask);    \
                                  gpio_set_mode(GPIOA, GPIO_MODE_OUTPUT_50_MHZ, GPIO_CNF_OUTPUT_PUSHPULL, lcd_ce);  }
  */
      #define lcd_pin_init()    ( gpio_set_mode(GPIOB, GPIO_MODE_OUTPUT_50_MHZ, GPIO_CNF_OUTPUT_PUSHPULL, lcd_pin_mask) )
      ...
      #define lcd_pin_mask      ( lcd_rst | lcd_dc )
      #define lcd_pin_init()    { gpio_set_mode(GPIOA, GPIO_MODE_OUTPUT_50_MHZ, GPIO_CNF_OUTPUT_PUSHPULL, lcd_pin_mask);  \
                                  gpio_set_mode(GPIOB, GPIO_MODE_OUTPUT_50_MHZ, GPIO_CNF_OUTPUT_PUSHPULL, lcd_ce); }
    ...
    //  -------------------------------------------------------------    
    //    Boards mit parallelem Interface
    //  -------------------------------------------------------------
    ...
    // Hier nichts aendern, die Bits der Portpins werden (aus Geschwindigkeitsgruenden)
    // in tftdisplay.c ueber Bitmanipulationen explizit gesetzt. Definitionen fuer 
    // D0 bis D7 dienen lediglich zu Versuchszwecken innerhalb tftdisplay.c
