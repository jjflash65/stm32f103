/* -----------------------------------------------------------------------------------
  ...
  #define mirror                  0                 // 0 : normale Ausgabe
    ...
    #define rgbseq                  0                 // Reihenfolge der erwarteten Farbuebergabe bei ST7735 LC-Controllern
                                                      // 0: blau-gruen-rot
                                                      // 1: rot-gruen-blau

    #define pindefs                 4                 // unterschiedliche Anschluesse an den Controller
                                                      // Deklarationen der Anschlusspins in tft_pindefs.h
                                                      // 1 : Anschluss Lochrasterboard
                                                      // 2 : Anschluss R3 - Evalboard (gedruckte Schaltung)
                                                      // 3 : Steckbrett
                                                      // 4 : TFT-Test Shield (umschaltbares Board 3.3V / 5V)
                                                      // 5 : TFT-Button Shield
                                                      // 6 : Steckbrett 2
